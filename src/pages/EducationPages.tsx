    ...
    <div className="w-full px-4 sm:px-6 lg:px-8 py-8 animate-fade-in">
      ...
      {loading ? (
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {filtered.map((a) => (
            <Link key={a.id} to={`/education/${a.slug}`} className="card overflow-hidden hover:shadow-neumorphic-sm transition-transform transition-shadow hover:-translate-y-0.5 group">
              {a.image_url ? (
      ...
      {loading ? (
        ...
        <div className="grid sm:grid-cols-2 gap-6">
          {campagnes.map((c) => {
            ...
            return (
              <Card key={c.id} className="overflow-hidden hover:shadow-neumorphic-sm transition-shadow">
                {c.image_url ? (
                  <div className="aspect-video overflow-hidden bg-sand-100">
  ...
  return (
    <div className="w-full px-4 sm:px-6 lg:px-8 py-8 animate-fade-in">
      ...
      {loading ? (
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {articles.map((a) => (
            <Link key={a.id} to={`/education/${a.slug}`} className="card overflow-hidden hover:shadow-neumorphic-sm transition-transform transition-shadow group">
              {a.image_url && (
                <div className="aspect-video overflow-hidden bg-sand-100">
