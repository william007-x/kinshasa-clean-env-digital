        ...
        {filtered.map((item, i) => (
          <Card key={i} className="overflow-hidden">
            <button onClick={() => setOpen(open === i ? null : i)} className="flex w-full items-center justify-between gap-4 px-5 py-4 text-left">
              ...
              <ChevronDown className={classNames('h-5 w-5 text-primary-400 flex-shrink-0 transition-transform', open === i && 'rotate-180')} />
            </button>
            {open === i && (
              <div className="px-5 pb-4 text-sm text-primary-600 leading-relaxed animate-fade-in">{item.a}</div>
            )}
          </Card>
        ))}
        {filtered.length === 0 && (
          <Card className="p-8 text-center text-primary-400">Aucune question trouvée. <Link to="/contact" className="text-primary-600 font-medium">Contactez-nous</Link></Card>
        )}
      </div>
    </div>
  );
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 py-8 animate-fade-in">
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {sections.map((s) => (
          <Link key={s.title} to={s.link} className="card p-6 hover:shadow-neumorphic-sm transition-transform transition-shadow group">
            ...
            <h3 className="font-display font-semibold text-primary-900">{s.title}</h3>
            <p className="mt-2 text-sm text-primary-500">{s.desc}</p>
          </Link>
        ))}
      </div>
    </div>
        ...
        <div className="space-y-4">
          <Card className="p-5">
            <div className="flex items-center gap-3 mb-2">
              ...
              <h3 className="font-display font-semibold text-primary-900">Email</h3>
            </div>
            <p className="text-sm text-primary-500">contact@kinshasaeco.cd</p>
          </Card>
          <Card className="p-5">
            <div className="flex items-center gap-3 mb-2">
              <Phone className="h-5 w-5 text-primary-600" />
              <h3 className="font-display font-semibold text-primary-900">Téléphone</h3>
            </div>
            <p className="text-sm text-primary-500">+243 890 000 000</p>
          </Card>
          <Card className="p-5">
            <div className="flex items-center gap-3 mb-2">
              <MapPin className="h-5 w-5 text-primary-600" />
              <h3 className="font-display font-semibold text-primary-900">Adresse</h3>
            </div>
            <p className="text-sm text-primary-500">Avenue de la Justice, Commune de Gombe, Kinshasa, RDC</p>
          </Card>
        </div>
        <Card className="p-6 lg:col-span-2">
          {sent ? (
            <div className="text-center py-8">
              ...
              <h3 className="font-display font-semibold text-primary-900">Message envoyé !</h3>
              <p className="mt-2 text-sm text-primary-500">Nous vous répondrons dans les plus brefs délais.</p>
            </div>
          ) : (
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-8 animate-fade-in">
      ...
      <Card className="p-8 prose prose-forest max-w-none">
        <div className="text-primary-700 leading-relaxed space-y-4">{children}</div>
      </Card>
    </div>
  );
}
...
export function MentionsLegalesPage() {
  return (
    <LegalLayout title="Mentions légales" updated="3 juillet 2025">
      <h2 className="font-display font-semibold text-primary-900">Éditeur de la plateforme</h2>
      ...
      <h2 className="font-display font-semibold text-primary-900">Hébergement</h2>
      ...
      <h2 className="font-display font-semibold text-primary-900">Propriété intellectuelle</h2>
      ...
      <h2 className="font-display font-semibold text-primary-900">Responsabilité</h2>
...
export function ConfidentialitePage() {
  return (
    <LegalLayout title="Politique de confidentialité" updated="3 juillet 2025">
      <h2 className="font-display font-semibold text-primary-900">Collecte des données</h2>
      ...
      <h2 className="font-display font-semibold text-primary-900">Utilisation des données</h2>
      <p>Vos données servent à : (1) gérer votre compte, (2) afficher vos signalements, (3) vous envoyer des notifications.</p>
      <h2 className="font-display font-semibold text-primary-900">Protection des données</h2>
      ...
      <h2 className="font-display font-semibold text-primary-900">Vos droits</h2>
      ...
      <h2 className="font-display font-semibold text-primary-900">Cookies</h2>
...
export function ConditionsPage() {
  return (
    <LegalLayout title="Conditions d'utilisation" updated="3 juillet 2025">
      <h2 className="font-display font-semibold text-primary-900">Acceptation des conditions</h2>
      ...
      <h2 className="font-display font-semibold text-primary-900">Comportement de l'utilisateur</h2>
      ...
      <h2 className="font-display font-semibold text-primary-900">Modération</h2>
      ...
      <h2 className="font-display font-semibold text-primary-900">Limitation de responsabilité</h2>
  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center px-4">
      <div className="text-center animate-fade-in-up">
        <div className="mx-auto flex h-20 w-20 items-center justify-center rounded-3xl bg-primary-100 text-primary-600 mb-6">
          <AlertTriangle className="h-10 w-10" />
        </div>
        <h1 className="font-display text-6xl font-extrabold text-primary-900">404</h1>
        <p className="mt-3 text-lg text-primary-600">La page que vous recherchez n'existe pas ou a été déplacée.</p>
  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center px-4">
      <div className="text-center animate-fade-in-up">
        ...
        <h1 className="font-display text-6xl font-extrabold text-primary-900">403</h1>
        <p className="mt-3 text-lg text-primary-600">Accès refusé. Vous n'avez pas les permissions nécessaires pour consulter cette page.</p>
        <Link to="/" className="btn-primary mt-6 inline-flex"><Home className="h-4 w-4" /> Retour à l'accueil</Link>
      </div>
    </div>
  );
  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center px-4">
      <div className="text-center animate-fade-in-up">
        ...
        <h1 className="font-display text-6xl font-extrabold text-primary-900">500</h1>
        <p className="mt-3 text-lg text-primary-600">Une erreur serveur est survenue. Notre équipe a été notifiée.</p>
